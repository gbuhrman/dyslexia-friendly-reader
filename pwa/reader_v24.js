...
(() => {
  ...
  window.reader.loadText = async function loadText(text, name, meta = {}) {
    ...
    // 3) If MC toggled on, apply red-letter NOW (markers fast), then wrap words
  ...
  document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (mcBtn) {
      ...
      mcBtn.addEventListener('click', () => {
        ...
        if (nowOn) {
          applyRedLetterIfEnabledNow();
        } else {
          // Remove wrappers but keep interior structure, then re-wrap words
